...
function Projects() {
    return(
        ...
        <div className="w-[358px] bg-[grey] px-[16px] py-[24px]  mt-[32px] lg:w-[1170px] lg:py-[64px] lg:px-[70px]"style={{backgroundImage: `url(${Audiolize1})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat',}} >
